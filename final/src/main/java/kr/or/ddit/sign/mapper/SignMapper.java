package kr.or.ddit.sign.mapper;
...
public interface SignMapper {
	...
	public int createPost2(SignVO signVO);
	...
	//결재그룹번호 등록
	public int createGroupPost(SignVO signVO);
	...
	//main
	public List<SignVO> signVOListD(Map<String, Object> map);
