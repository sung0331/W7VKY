...
<!-- 헤더 include  -->
	...
	<div>
                    ...
                    <div class="nav nav-tabs custom-tabs">
					   <a class="nav-link" href="/sign/end">종결함</a>
					   <a class="nav-link active" href="/sign/collect">반려함</a>
					 </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody id="tby">
                              <!--   <tr>
                                    ...
                                    <td>인사부</td>
                                    <td>개똥이</td>
                                    /* <td>\${signVO.appTypeId}</td>
						 		<td>\${signVO.befAppTypeId}</td> */
                                </tr> -->
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="" id="divPagingArea" style="width: 30%; margin: 0 auto; background-color:white;">
                     ...
                     <div class="" style="justify-content:right;display:flex; margin:8px;">
...
<!-- ///// footer 끝 ///// -->  
 			...
 			success:function(result){
 				...
 				$.each(result.content,function(idx, signVO){
	 				str += `<tr data-original-emp-no="\${signVO.originalEmpNo}" data-reapp-emp-id="\${signVO.reappEmpId}">
						 		...
						 		<td class="text-center"><a href="/sign/retractDetail?appGroupCode=\${signVO.appGroupCode}">\${signVO.docTitle}</a></td>
					 			...
					 			<td class="text-center"><input type="checkbox" name="checkbox-\${signVO.rnum}" value="\${signVO.rnum}"></td>
				 			</tr>`;
	 			});
 	...
 	$(function(){
 		...
 		$(document).on("click",".clsPagingArea",function(){
			...
			selectSign(currentPage, keyword);
 		});
